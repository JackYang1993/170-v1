...
public class MailUtil {
	...
	public static int sendSimpleMail(String recipients,String title,String content) {
		int res = 0;
		try {
			// 2.创建一个会话对象和邮件服务器交互
			...
			message.setFrom(new InternetAddress("1197177914@qq.com")); // 发送人
			...
			transport.connect("1197177914@qq.com", "jocjbzuhgzezbafj");// 设置发送邮件用户名和授权码
